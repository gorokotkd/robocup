...
import rescuecore2.worldmodel.properties.StringProperty;
...
public abstract class Human extends StandardEntity {
  ...
  protected Human( EntityID id ) {
    ...
    team = new StringProperty( StandardPropertyURN.TEAM );
    registerProperties( x, y, position, positionHistory, travelDistance,
        direction, stamina, hp, damage, buriedness, team );
  }
  ...
  public Human( Human other ) {
    ...
    team = new StringProperty( other.team );
    registerProperties( x, y, position, positionHistory, travelDistance,
        direction, stamina, hp, damage, buriedness, team );
  }
  ...
  /**
   * Find out if the team property has been defined.
   *
   * @return True if the team property has been defined, false otherwise.
   */
  ...
  /**
   * Undefine the team property.
   */
  public void undefineTeam() {
    team.undefine();
  }
  ...
  public JSONObject toJson() {
    ...
    jsonObject.put( StandardPropertyURN.POSITION_HISTORY.toString(),
        this.isPositionHistoryDefined() ? this.getPositionHistory()
            : JSONObject.NULL );
    jsonObject.put( StandardPropertyURN.TEAM.toString(),
            this.isTeamDefined() ? this.getTeam()
                    : JSONObject.NULL );
    jsonObject.put( StandardPropertyURN.STAMINA.toString(),
            this.isStaminaDefined() ? this.getTeam()
                    : JSONObject.NULL );
