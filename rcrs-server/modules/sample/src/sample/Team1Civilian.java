 ...
 */
public class Team1Civilian extends AbstractSampleAgent<Civilian> {

  private static final Logger LOG = Logger.getLogger(Team1Civilian.class);
  ...
  public Registry getPreferredRegistry(Registry parent) {
    ...
    Registry result = new Registry("Team1 Civilian filter registry", super.getPreferredRegistry(parent));
